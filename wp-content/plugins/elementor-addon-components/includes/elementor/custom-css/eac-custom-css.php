...
class Eac_Custom_Css {
	...
	public function enqueue_editor_scripts() {
		wp_enqueue_script('eac-editor-support-js', EAC_ADDONS_URL . 'assets/js/elementor/eac-custom-css.js', array('jquery'), EAC_ADDONS_VERSION, true);
	}
	...
	public static function add_controls_section($element, $section_id, $args) {
		if ($section_id == 'section_custom_css_pro') {
			...
			$element->start_controls_section('section_custom_css',
				[
					'label' => __('EAC CSS personnalisé', 'eac-components'),
			...
			$element->add_control('custom_css_title',
				[
					'raw' => __('Ajoutez votre propre CSS', 'eac-components'),
			...
			$element->add_control('custom_css',
				[
					...
					'label' => __('CSS personnalisé', 'eac-components'),
					'language' => 'css',
					'render_type' => 'ui',
					'show_label' => false,
					'separator' => 'none',
