...
class Eac_Acf_Tags {
	...
	*/
	public function register_tags($dynamic_tags) {
		...
		\Elementor\Plugin::$instance->dynamic_tags->register_group('eac-acf-groupe', ['title' => __('ACF', 'eac-components')]);
		
		/** ----- @since 1.7.5/1.7.6/1.8.2/1.8.3/1.8.4 ACF 5.0 -----*/
		
		require_once(__DIR__ . '/tags/acf-field-keys.php');
		// Enregistre le tag pour filtrer les articles sur la clé des champs ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Post_Acf_Keys());
		
		require_once(__DIR__ . '/tags/acf-field-values.php');
		// Enregistre le tag pour filtrer les articles sur les valeurs des champs ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Post_Acf_Values());
		
		require_once(__DIR__ . '/tags/acf-field-number.php');
		// Enregistre le tag pour le type de champ NUMBER de ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Number());
		
		require_once(__DIR__ . '/tags/acf-field-text.php');
		// Enregistre le tag pour les types de champ TEXT de ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Text());
		
		require_once(__DIR__ . '/tags/acf-field-color.php');
		// Enregistre le tag pour les types de champ COLOR_PICKER de ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Color());
		
		require_once(__DIR__ . '/tags/acf-field-url.php');
		// Enregistre le tag pour les types de champ URL de ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Url());
		
		require_once(__DIR__ . '/tags/acf-field-image.php');
		// Enregistre le tag pour les types de champ IMG de ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Image());
		
		/** @since 1.8.0 */
		require_once(__DIR__ . '/tags/acf-field-relational.php');
		// Enregistre le tag pour les types de champ Relationship & Post Object de ACF
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Relational());
		
		/** @since 1.8.3 */
		require_once(__DIR__ . '/tags/acf-field-group-text.php');
		// Enregistre le tag pour les TEXTs du type de champ Group
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Group_Text());
		
		/** @since 1.8.3 */
		require_once(__DIR__ . '/tags/acf-field-group-url.php');
		// Enregistre le tag pour les URLs du type de champ Group
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Group_Url());
			
		/** @since 1.8.3 */
		require_once(__DIR__ . '/tags/acf-field-group-image.php');
		// Enregistre le tag pour les IMAGESs du type de champ Group
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Group_Image());
			
		/** @since 1.8.3 */
		require_once(__DIR__ . '/tags/acf-field-group-color.php');
		// Enregistre le tag pour les COLORs du type de champ Group
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Group_Color());
		
		/** @since 1.8.3 */
		require_once(__DIR__ . '/tags/acf-field-group-number.php');
		// Enregistre le tag pour les NUMBERs du type de champ Group
		$dynamic_tags->register_tag(new \EACCustomWidgets\Includes\Elementor\DynamicTags\ACF\Tags\Eac_Acf_Group_Number());
	}
	...
	public static function get_acf_field_name($metavalue, $metakey, $postid) {
		...
		if($meta_key && !empty($meta_key) && count($meta_key) == 1) { // Il ne doit yu avoir qu'une seule meta_key
