...
class Eac_Featured_Image_Data extends Tag {
    ...
    public function get_title() {
		return __("Données de l'image en avant", 'eac-components');
	}
	...
	protected function register_controls() {
		$this->add_control('eac_attachement_data',
			[
				'label' => __('Data', 'eac-components'),
				'type' => Controls_Manager::SELECT,
				'default' => 'title',
				'options' => [
					'title' => __('Titre', 'eac-components'),
					'alt' => __('Alt', 'eac-components'),
					'caption' => __('Légende', 'eac-components'),
					'description' => __('Description', 'eac-components'),
					'src' => __("URL de l'image", 'eac-components'),
					'href' => __("URL de l'Attachement", 'eac-components'),
				],
			]
		);
	}
