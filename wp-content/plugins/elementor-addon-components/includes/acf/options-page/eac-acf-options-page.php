...
class Eac_Acf_Options_Page {
	...
	function register_option_page_post_type() {
		...
		$labels = array(
			...
			'menu_name'             => __('ACF Options', 'eac-components'),
			'name_admin_bar'        => __('ACF Options', 'eac-components'),
			'archives'              => __('Liste Archives', 'eac-components'),
			'parent_item_colon'     => __('Parent', 'eac-components'),
			'all_items'             => __("Toutes les Pages d'Options", 'eac-components'),
			'add_new_item'          => __("Nouvelle Page d'Options", 'eac-components'),
			'add_new'               => __('Ajouter', 'eac-components'),
			'new_item'              => __("Nouvelle Page d'Options", 'eac-components'),
			'edit_item'             => __("Ajouter une Page d'Options", 'eac-components'),
			'update_item'           => __("Modifier une Page d'Options", 'eac-components'),
			'view_item'             => __("Voir une Page d'Options", 'eac-components'),
			'search_items'          => __("Chercher dans les Pages d'Options", 'eac-components'),
			'not_found'             => __('Pas trouvé', 'eac-components'),
			'not_found_in_trash'    => __('Pas trouvé dans la poubelle', 'eac-components')
		);
		
		$args = array(
			'label'                 => __("Liste des Pages d'Options", 'eac-components'),
			'labels'                => $labels,
	...
	function add_site_settings_to_menu() {
		$plugin_slug = 'eac-components';
		$callback = "edit.php?post_type=" . self::$acf_post_type;
		$title =  __("ACF Pages d'Options", "eac-components");
		add_submenu_page($plugin_slug, $title, $title, 'manage_options', $callback);
	}
	...
	function add_columns($columns) {
		...
		return array_merge($columns,
			array(
				'eac_type' => __('Type', 'eac-components'),
				'eac_group' => __('Groupes', 'eac-components'),
				'eac_field' => __('Champs', 'eac-components'),
				'eac_field_saved' => __('Enregistrés', 'eac-components'),
				'eac_id' => 'ID',
			)
		);
	}
