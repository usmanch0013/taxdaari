...
/*=================================================================================
* Description: Collecte les données (likes) d'une image (post)
...
* Méthode 'getPostLikes' retourne les 50 derniers likes d'un posts
...
if(! $edges = $endpoints->getPostLikes($_REQUEST['instagram'])) {
	exit;
}
