...
Tags: page-builder, elementor, components, addon, widget, dynamic tags, custom css, template, external image, syntax highlighter, TOC
...
=== Language ===
The default language of the components is French. The English version is available in the general settings page – English (United States).
