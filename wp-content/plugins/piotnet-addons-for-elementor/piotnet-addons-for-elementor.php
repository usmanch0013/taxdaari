...
define( 'PAFE_VERSION', '2.4.13' );
define( 'PAFE_PREVIOUS_STABLE_VERSION', '2.4.12' );
...
final class Piotnet_Addons_For_Elementor {
	...
	public function enqueue() {
		wp_enqueue_script( 'pafe-extension-free', plugin_dir_url( __FILE__ ) . 'assets/js/minify/extension.min.js', array('jquery'), self::VERSION );
		wp_enqueue_style( 'pafe-extension-style-free', plugin_dir_url( __FILE__ ) . 'assets/css/minify/extension.min.css', [], self::VERSION );		
	}

	public function enqueue_scripts_widget() {
		wp_register_script( 'pafe-widget-free', plugin_dir_url( __FILE__ ) . 'assets/js/minify/widget.min.js', array('jquery'), self::VERSION );
	}

	public function enqueue_styles_widget() {
		wp_register_style( 'pafe-widget-style-free', plugin_dir_url( __FILE__ ) . 'assets/css/minify/widget.min.css', [], self::VERSION );
	}
